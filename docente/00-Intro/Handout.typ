...
Nel frattempo, uno strumento fortemente consigliato per famigliarizzare con Git, il suo funzionamento e i suoi vari comandi è "Oh my Git!", un gioco didattico open-source che guida passo passo nell'apprendimento di questo potente sistema di controllo del versionamento. Il gioco è disponibile all'indirizzo https://ohmygit.org/ (https://311to.site/at) e può essere scaricato gratuitamente per Windows, macOS e Linux.
