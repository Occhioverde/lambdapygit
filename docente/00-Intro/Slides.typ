...
#slidew(
  slide_title: "Oh my Git!",
  title: title, course: course, author: author
)[
  Per famigliarizzare con Git prima di provare a versionare il nostro script Python, useremo un gioco didattico chiamato "Oh my Git!", scaricabile all'indirizzo:

  #center_url("https://311to.site/at")
]
